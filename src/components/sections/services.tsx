...
const services = [
  {
    ...
    description: "Full-stack SaaS platforms from idea to scale",
    icon: Cloud,
    features: [
  ...
  },
  {
    ...
    description: "Integrate cutting-edge AI into your products",
    icon: Brain,
    features: [
      "Custom AI Models",
      "ChatGPT Integration",
  ...
  },
  {
    ...
    description: "Lightning-fast, SEO-optimized web experiences",
    icon: Globe,
    features: [
