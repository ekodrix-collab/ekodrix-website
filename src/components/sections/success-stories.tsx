...
const successStories = [
  {
    id: "resellerpro",
    name: "ResellerPro",
    tagline: "From Idea to 10,000+ Users",
    description: "Built India's fastest-growing reseller CRM from scratch. Now processing ₹500Cr+ monthly.",
    metrics: [
      { label: "MRR", value: "₹5L+", icon: TrendingUp, color: "text-ekodrix-green" },
      { label: "Active Users", value: "10,000+", icon: Users, color: "text-resellerpro-blue-light" },
      { label: "Uptime", value: "99.9%", icon: Shield, color: "text-purple-400" },
      { label: "Processing Time", value: "<2s", icon: Zap, color: "text-orange-400" },
    ],
  ...
  },
  {
    ...
    tagline: "₹500Cr+ Transactions Processed",
    description: "Enterprise payment processing platform handling 50,000+ daily transactions with 99.99% success rate.",
    metrics: [
      { label: "Monthly Volume", value: "₹500Cr+", icon: TrendingUp, color: "text-ekodrix-green" },
      { label: "Success Rate", value: "99.99%", icon: Shield, color: "text-green-400" },
      { label: "Processing", value: "<2s", icon: Zap, color: "text-yellow-400" },
      { label: "Daily Txns", value: "50K+", icon: Users, color: "text-blue-400" },
    ],
  ...
  },
  {
    ...
    description: "HIPAA-compliant appointment platform serving 5,000+ healthcare providers nationwide.",
    metrics: [
      { label: "Providers", value: "5,000+", icon: Users, color: "text-blue-400" },
      { label: "Appointments", value: "100K/mo", icon: TrendingUp, color: "text-ekodrix-green" },
      { label: "Time Saved", value: "40%", icon: Zap, color: "text-orange-400" },
